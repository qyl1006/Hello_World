				...
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">
							...
							仓库
							<select class="ui_select01 depotId" name="depotId">
								...
								<td>
									<c:choose>
										<c:when test="${item.status == 1}">
											...
											<a href="javascript:"  data-url="/stockIncomeBill/delete.do?id=${item.id}"
											   class="btn_delete">删除</a>
											<a href="javascript:" data-url="/stockIncomeBill/auditor.do?id=${item.id}" class="btn_audit">审核</a>
										</c:when>
										<c:when test="${item.status == 2}">
